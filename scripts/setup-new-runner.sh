...
echo "     sudo reboot"
echo ""
echo "2. After reboot, setup Docker logging and GitHub Actions runner:"
echo "     cd ~/canada-research"
echo "     sudo bash ./scripts/setup-docker-logging.sh"
echo "     ./scripts/setup-runner.sh"
echo ""
echo "3. Setup monitoring (recommended):"
echo "     # Install tmux for persistent monitoring"
echo "     sudo apt-get install -y tmux"
echo "     # Start monitoring dashboard"
echo "     tmux new -d -s monitoring 'bash ~/canada-research/scripts/runner-dashboard.sh'"
echo "     # Attach to see dashboard: tmux attach -t monitoring"
echo ""
echo "4. Add secrets to repo:"
